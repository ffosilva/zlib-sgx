...
if(SGX_FOUND)
    set(SGX_MODE HW CACHE BOOL "HW to run SGX on hardware, SIM for simulation.")
    set(SGX_BUILD PRERELEASE CACHE STRING "SGX build mode: DEBUG; PRERELEASE; RELEASE.")
    ...
    elseif(SGX_BUILD STREQUAL "RELEASE")
        ...
        message(FATAL_ERROR "SGX_BUILD ${SGX_BUILD} is not DEBUG, PRERELEASE or RELEASE.")
    endif()
    ...
    function(enclave_sign target)
        ...
        if("${SGX_KEY}" STREQUAL "")
            if (NOT SGX_HW OR NOT SGX_BUILD STREQUAL "RELEASE")
        ...
        if(SGX_HW AND SGX_BUILD STREQUAL "RELEASE")
